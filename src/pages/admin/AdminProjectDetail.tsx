            ...
            tabs={[
              ...
              },
              {
                ...
                subTabs: [
                  ...
                  { key: "bookkeeping", label: "Bookkeeping", content: <BookkeepingAdmin projectId={project.id} projectName={project.code} projectAddress={project.address} gcName={project.gc_name || ""} /> },
                ],
              },
              {
                key: "reportes",
